			...
			<div className='cards-container'>
				...
				{this.state.latestLaunchIsOpen ? (
					<Modal handleClick={this.handleLatestLaunch}>
						...
						<a
							href={this.state.latest.links.webcast}
							target='_blank'
							rel='noreferrer'
						>
				...
				<Card>
					...
					>
						...
						<p className='container__paragraph'>
							...
							Date Precision: {
								this.state.next.date_precision
							}{' '}
							<br />
							Flight Number: {this.state.next.flight_number}{' '}
							<br />
							{this.state.next.links.wikipedia && (
								<>
									Wikipedia:{' '}
									<a
										href={this.state.next.links.wikipedia}
										target='_blank'
										rel='noreferrer'
									>
										{this.state.next.links.wikipedia}
							...
							{this.state.next.links.webcast && (
								<>
									Webcast:{' '}
									<a
										href={this.state.next.links.webcast}
										target='_blank'
										rel='noreferrer'
									>
										{this.state.next.links.webcast}
					...
					<Modal handleClick={this.handleLatestRocket}>
						...
						>
							...
							<span className='info-container__items'>
								...
								{this.state.latestRocket.cost_per_launch /
									1000000}{' '}
								millions
							</span>
						</div>
						...
						<a
							href={this.state.latestRocket.wikipedia}
							target='_blank'
							rel='noreferrer'
						>
							<button className='modal__link-button'>
				...
				{this.state.nextRocketIsOpen ? (
					<Modal handleClick={this.handleNextRocket}>
						...
						>
							...
							<span className='info-container__items'>
								<h3>Cost per Launch</h3>$
								{this.state.nextRocket.cost_per_launch /
									1000000}{' '}
								millions
							</span>
						</div>
						...
						<a
							href={this.state.nextRocket.wikipedia}
							target='_blank'
							rel='noreferrer'
						>
							<button className='modal__link-button'>
